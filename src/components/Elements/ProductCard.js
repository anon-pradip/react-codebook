  ...
  return (
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      <Link to="" className="relative" >
        ...
        <img className="rounded-t-lg w-full h-64" src="/assets/images/10001.avif" alt='test-for-now' />
      </Link>
      <div className="p-5">
        <Link to="">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">ProductCard</h5>
        </Link>
